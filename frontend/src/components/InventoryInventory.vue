<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text>
            <Number v-if="editMode" label="ProductId" v-model="value.productId" :editMode="editMode" :inputUI="''"/>
            <Number label="StockRemain" v-model="value.stockRemain" :editMode="editMode" :inputUI="''"/>
        </v-card-text>
